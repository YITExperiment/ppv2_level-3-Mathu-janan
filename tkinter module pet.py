...
fill='black')
mouth_normal = c.create_line(170, 250, 200, 282, 230, 250,
smooth=1, width=2, state=NORMAL)


mouth_happy = c.create_line(170, 250, 200, 292, 230, 250,
smooth=1, width=2, state=HIDDEN)
mouth_sad = c.create_line(170, 250, 200, 232, 230, 250,
smooth=1, width=2,state=HIDDEN)
cheek_lift = c.create_oval(70, 180, 120, 230, outline='pink',
